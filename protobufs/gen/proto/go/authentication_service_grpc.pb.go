...
type AuthenticationServiceClient interface {
	...
	Status(ctx context.Context, in *SessionRequest, opts ...grpc.CallOption) (*SessionResponse, error)
}
...
type AuthenticationServiceServer interface {
	...
	Status(context.Context, *SessionRequest) (*SessionResponse, error)
...
func (UnimplementedAuthenticationServiceServer) Status(context.Context, *SessionRequest) (*SessionResponse, error) {
...
func _AuthenticationService_Status_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SessionRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthenticationServiceServer).Status(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
...
var AuthenticationService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Status",
			Handler:    _AuthenticationService_Status_Handler,
		},
	},
